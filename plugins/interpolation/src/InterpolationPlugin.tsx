...
import { Box, Slider, Button, TextField, Stack, Typography} from "@mui/material";
...
export default function InterpolationPanel() {
  ...
  const handleLeftChange = (event) => {
    // Update the state variable with the current TextField value
  ...
  const operatorExecutor = useOperatorExecutor('interpolation/interpolator')
...
export const InterpolationIcon = ({ size = 41, style = {} }) => {
  return (
...
function interpolationActivator() {
  ...
  console.log("brainMethods", brainMethods);
