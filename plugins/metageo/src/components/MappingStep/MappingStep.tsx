  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: "auto", p: 3 }}>
      ...
      <Typography variant="body1" sx={{ mb: 4, color: "text.secondary" }}>
        Configure how OpenStreetMap data should be mapped to your dataset. You can
        create 3D detections, tag samples, map OSM tags to fields, and include
        metadata.
      </Typography>
      ...
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
          OSM tags from your indexed data are automatically loaded to help configure mappings.
        </Typography>
        ...
        {osmTags.length === 0 && !osmTagsLoading && !osmTagsError && osmTagsHasLoaded && (
              ...
              {mappingConfig.enableSampleTagging && (
                <Stack spacing={3}>
                  <TextField
                    ...
                    placeholder="e.g., default, tags, metadata"
                    helperText="The slice where tags will be stored"
                    fullWidth
                  />
                  ...
                  <TextField
                    ...
                    onChange={(e) =>
                      mappingActions.setTagRadius(Number(e.target.value))
                    }
                    helperText="OSM nodes further than this distance will not be considered"
                    inputProps={{ min: 1, max: 10000 }}
                    fullWidth
                  />
                  ...
                  <Box>
                    ...
                    <Alert severity="info" sx={{ mb: 2 }}>
                      Configure which OSM tags should be used for sample tagging.
                      For example, map "building=yes" to a boolean field.
                    </Alert>
                    <TagMappingConfig
