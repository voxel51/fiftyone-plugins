...
This repository contains two collections of
...
1. Core plugins that are maintained by the FiftyOne team, and
2. Example plugins, which are here to inspire you to create your own plugins!

<!-- Autogenerated by `scripts/make_table.py` -->
<table>
    <tr>
        <th colspan="6">Core Plugins</th>
    </tr>
    <tr>
        <th>Name</th>
        <th>Description</th>
...
<table>
    <tr>
        <th colspan="6">Example Plugins</th>
    </tr>
    <tr>
        <th>Name</th>
        <th>Description</th>
    ...
    <tr>
        <td><b><a href="https://github.com/jacobmarks/image-quality-issues/blob/main/README.md">image_issues</a></b></td>
        <td>Find common image quality issues in your datasets</td>
        <td><code>1.0.0</code></td>
        <td><a href="https://github.com/jacobmarks/image-quality-issues/blob/main/README.md">About</a></td>
        <td><a href="https://github.com/jacobmarks/image-quality-issues/blob/main/README.md#installation">Install</a></td>
        <td>
            <a href="https://github.com/jacobmarks/image-quality-issues/blob/main/README.md#operators">Operators</a>
        </td>
    </tr>
    <tr>
