...
<table>
    ...
    <tr>
        ...
        <td><kbd>curation</kbd> <kbd>visualization</kbd></td>
    ...
    <tr>
        ...
        <td><kbd>model</kbd> <kbd>dataset</kbd></td>
...
<table>
    ...
    <tr>
        ...
        <td><kbd>dataset</kbd> <kbd>huggingface</kbd></td>
    ...
    <tr>
        ...
        <td><kbd>model</kbd> <kbd>huggingface</kbd></td>
...
<table>
    ...
    <tr>
        ...
        <td><kbd>model</kbd> <kbd>tracking</kbd></td>
    ...
    <tr>
        ...
        <td><kbd>model</kbd> <kbd>depth</kbd></td>
    ...
    <tr>
        ...
        <td><kbd>visualization</kbd> <kbd>hyperspectral</kbd></td>
    ...
    <tr>
        ...
        <td><kbd>model</kbd> <kbd>embeddings</kbd></td>
    ...
    <tr>
        ...
        <td><kbd>model</kbd> <kbd>medical</td>
    ...
    <tr>
        ...
        <td><kbd>dataset</kbd> <kbd>medical</kbd></td>
        <td>🏥 EgoExOR is an Operating Room dataset fusing egocentric and exocentric perspectives for surgical procedures. See <a href="https://github.com/ardamamur/EgoExOR/tree/main/data#-visualization-optional">here</a> to load it with FiftyOne.</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><kbd>model</kbd> <kbd>3d</kbd></td>
    ...
    <tr>
        ...
        <td><kbd>model</kbd> <kbd>segmentation</kbd></td>
    ...
    <tr>
        ...
        <td><kbd>model</kbd> <kbd>evaluation</kbd> <kbd>text</kbd></td>
    ...
    <tr>
        ...
        <td><kbd>model</kbd> <kbd>vlm</kbd></td>
        <td> 📜 MinerU2.5 is a 1.2B-parameter vision language model for efficient high-resolution document parsing. This model can support grounding OCR as well as free text OCR.</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><kbd>model</kbd> <kbd>ocr</kbd></td>
    ...
    <tr>
        ...
        <td><kbd>visualization</kbd> <kbd>vlm</kbd></td>
    ...
    <tr>
        ...
        <td><kbd>utils</kbd> <kbd>evaluation</kbd></td>
    ...
    <tr>
        ...
        <td><kbd>model</kbd> <kbd>medical</kbd></td>
    ...
    <tr>
        ...
        <td><kbd>model</kbd> <kbd>pose</kbd></td>
    ...
    <tr>
        ...
        <td><kbd>model</kbd> <kbd>depth</kbd></td>
        <td>🥽 Perfom zero-shot metric monocular depth estimation using the Apple Depth Pro model</kbd></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><kbd>model</kbd> <kbd>video</kbd></td>
    ...
    <tr>
        ...
        <td><kbd>model</kbd> <kbd>vqa</kbd></td>
    ...
    <tr>
        ...
        <td><kbd>model</kbd> <kbd>search</kbd></td>
    ...
    <tr>
        ...
        <td><kbd>audio</kbd> <kbd>visualization</kbd></td>
    ...
    <tr>
        ...
        <td><kbd>search</kbd> <kbd>embeddings</kbd></td>
    ...
    <tr>
        ...
        <td><kbd>model</kbd> <kbd>vlm</kbd> <kbd>curation</kbd></td>
    ...
    <tr>
        ...
        <td><kbd>vlm</kbd> <kbd>evaluation</kbd></td>
        <td>🤖 A comprehensive FiftyOne plugin for testing and evaluating multiple vision langugage models with dynamic prompts and built-in evaluation capabilities</td>
    </tr>
    <tr>
    ...
    <tr>
        <td><b><a href="https://github.com/Burhan-Q/patch-hunter">@Burhan-Q/patch-hunter</a></b></td>
        <td><kbd>examples</kbd></td>
        <td>🎮 A fast-paced reflex game panel — click streaming object-detection patches that match the rotating target label before time runs out, build streaks, and land on the leaderboard.</td>
    </tr>
</table>
